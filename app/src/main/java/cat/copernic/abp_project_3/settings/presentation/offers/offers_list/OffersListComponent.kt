package cat.copernic.abp_project_3.settings.presentation.offers.offers_list
...
/**
 * Component that contains all the ui element referent to the offers list component
 *
 * @param handleMenuBackNavigation
 * @param offersListComponent
 * @param handleDetails
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun OffersListComponent(
    handleMenuBackNavigation: () -> Unit,
    offersListComponent: List<Offer>,
